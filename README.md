...
<img src="logo.png" width="128" height="128" alt="STORM TRANSLATOR Logo" />

# ⚡ STORM TRANSLATOR

<p align="center">
  <b>Экранный переводчик в реальном времени с OCR распознаванием текста из игр и программ.</b>
</p>

[![Version](https://img.shields.io/badge/version-0.9.0-00D2FF.svg?style=for-the-badge)](https://github.com/ReiKatari/STORM_TRANSLATOR)
[![Platform](https://img.shields.io/badge/Platform-Windows%2011%20%7C%2010-0EA5E9.svg?style=for-the-badge)](https://github.com/ReiKatari/STORM_TRANSLATOR)
...
**STORM TRANSLATOR** — компонент программного комплекса **STORM**, разработанный с упором на максимальную производительность, современный дизайн и надёжность.
...
1. Запустите файл STORM_STORM_TRANSLATOR_0.9.0_Setup.exe.
2. Выберите режим:
   * **Стандартная установка** — установка в C:\Program Files\STORM TRANSLATOR с созданием ярлыков и регистрацией в системе.
